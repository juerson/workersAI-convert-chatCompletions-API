...
let api_key = 'sk-x6y45fl59q07r113e9k729345y9wic6b29a20b1d84zo3fh5'; // 自己随意定义的（建议使用字母、数字），等同 OpenAI_Api_Key ，建议以"sk-"开头，方便区分
let cf_account_array = [{ account_id: 'n6pi2hclchld4ph789j508ah49s414ls', token: 'Fqdt3fR0hjF7439UL-jVr3q1oW7I2e3_Goan80Rx' }]; // 可以多配置几个账号，随机切换使用
// ——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
